ARG PYTHON_VERSION=3.7.10 # https://github.com/docker/compose/blob/master/Dockerfile#L2
...
ARG PYINSTALLER_VER=4.1 # https://github.com/docker/compose/blob/master/requirements-build.txt
